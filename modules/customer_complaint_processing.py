...
def ai_text_answer(data, question):
    ...
    try:
        ...
        ticket_instance.create_ticket(
            UUID, email, question, ai_text.to_dict()["candidates"][0]["content"]["parts"][0]["text"], ai_structure, data)
...
#   $$/      $$/ $$/   $$/ $$/   $$/    $$/             $$/    $$/   $$/ $$$$$$$$/       $$/        $$$$$$/   $$$$$$/  $$/   $$/       $$$$$$$/   $$$$$$/  $$/      $$/ $$$$$$/ $$/   $$/ $$$$$$/  $$$$$$  | $$$$$$/  $$$$$$$$/
#                                                                                                                                                                                                      $$$/
    return ai_text.to_dict()["candidates"][0]["content"]["parts"][0]["text"]
