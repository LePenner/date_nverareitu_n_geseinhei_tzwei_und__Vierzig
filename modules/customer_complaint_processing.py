...
def gemini_api_startup():

    with open('modules/functionals/credentials.json', 'r') as json_file:
        jsonCredentialsData = json.load(json_file)

def complaintPorcessing(complaint:str):

  with open('functionals/credentials.json', 'r') as json_file:
      jsonCredentialsData = json.load(json_file)
...
#print(complaintPorcessing("my vacuum ate my hamster and my mower is running out of battery to fast"))